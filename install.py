...
""")
	...
	if system0 == "1":
		...
		install = os.system("apt-get update && apt-get install -y nmap hping3 build-essential python-pip git libpcap-dev libgmp3-dev && pip install tabulate terminaltables")
		...
		install = os.system("apt-get update && apt-get install -y nmap hping3 git libpcap-dev libgmp3-dev python-tabulate python-terminaltables")
